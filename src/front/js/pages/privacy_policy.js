...
<div className="privacy_policy">
    <p>[[NOTE TO MERCHANT: Please read and remove/replace text wrapped in double square brackets like this]]
...
TTrustMyWords Privacy Policy.
Last updated: [[Date]]

This Privacy Policy describes how TTrustMyWords (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from https://victormagacbt-expert-garbanzo-qrwx5jvrr7ph6779-3000.preview.app.github.dev/ (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
...
Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call [[TOLL FREE TELEPHONE NUMBER IF YOU HAVE A PHYSICAL RETAIL LOCATION]] or email us at victor_miguel@msn.com or contact us at Rua do sobe e desce 56, Pingadeiras, PT-03, 4986-225, Portugal.

[[NOTE TO MERCHANT: INSERT THE FOLLOWING IF YOUR SITE IS GOVERNED BY GDPR]] For the purpose of applicable data protection laws, we are the data controller of your personal information. Our representative in the [[EEA]] [[and]] [[the UK]] is [[INSERT REPRESENTATIVE DETAILS]].</p>
</div>
);
}