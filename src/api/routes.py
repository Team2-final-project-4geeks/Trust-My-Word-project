...
def create_review():
    ...
    new_review= Review(title = data["title"], category=data["category"], description=data["description"], publishing_date= data["publishing_date"], price= data["price"], user_id=data["user"] ,image= data["imageCloud"])
